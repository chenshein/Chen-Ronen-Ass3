          ...
          <textarea
              onKeyDownCapture={(e) => {
                ...
                console.log(e.target.value);
                  ...
                  // Append a new line character to the textarea value
                  const updatedValue = e.target.value + newLine;

                  // Update the state with the new value
                  handleInputChange({ ...e, target: { ...e.target, value: updatedValue } });
                  ...
                  const trimmedValue = e.target.value.trim(); // Remove leading and trailing white spaces
